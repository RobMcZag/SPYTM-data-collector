...
public class UnderlyingQuote {
    ...
    @Id private LocalDate quoteDate;

    public UnderlyingQuoteId getId() { return new UnderlyingQuoteId(symbol, quoteDate); }
    ...
    private LocalDateTime regularMarketTime;//1609448402,
    ...
    private LocalDateTime postMarketTime;//1609462778,
